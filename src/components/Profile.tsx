...
const Profile = () => {
  return (
    <section className="relative inline-flex overflow-hidden rounded-lg p-[3px] focus:outline-none w-full">
      ...
      <div className="relative z-10 flex flex-col w-full h-full items-center justify-center rounded-lg dark:bg-slate-950 bg-slate-100 text-black text-sm font-medium dark:text-white backdrop-blur-3xl p-4">
