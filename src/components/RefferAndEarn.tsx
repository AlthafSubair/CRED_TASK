...
const RefferAndEarn = () => {
  ...
  return (
   <section className="relative flex flex-col justify-center items-center overflow-hidden rounded-lg p-[3px] focus:outline-none w-full border dark:border-slate-800 border-slate-300">
      ...
      <div className="relative z-10 flex gap-4 flex-col justify-center w-full  rounded-lg dark:bg-slate-950 bg-slate-100 text-black text-sm font-medium dark:text-white backdrop-blur-3xl py-4 px-4 lg:px-6">

  <div className='flex flex-row gap-4 items-center'>
    <FaHandHoldingUsd size={32} className="text-[#e7029a]"/>
    <h1 className='font-semibold lg:text-xl md:text-lg'>Refer & Earn ₹200 + 1000 XP</h1>
  </div>

  <p className=' text-justify pb-4'>Invite your friends to join. Get ₹200 + 1000 XP when they pay their first bill.</p>
