...
const Recharges = ({text, Icon}: Props) => {
  ...
  {/* Inner content */}
  <div className="relative z-10 flex flex-row w-full items-center rounded-lg dark:bg-slate-950 bg-slate-100 text-black text-sm font-medium dark:text-white backdrop-blur-3xl">
    ...
    <h1 className='lg:text-lg font-semibold'>{text}</h1>
  </div>
</section>
